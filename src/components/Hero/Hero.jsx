      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[700px] md:min-h-[600px] xl:mb-4 relative z-10">
          ...
          initial={{
              ...
              className="w-[90%] md:w-[550px] xl:w-[750px] rounded-2xl overflow-hidden"
            >
              <video
                autoPlay
                loop
        ...
        <div className='md:flex justify-center items-center left-1/2 translate-x-1/2 py-2 hidden'>
          <FaArrowDown className='p-[1vw] xl:text-7xl text-3xl animate-bounce cursor-pointer rounded-full hover:bg-zinc-300/30' onClick={() => {
            window.scrollBy({
